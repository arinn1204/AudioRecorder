...
set_property PACKAGE_PIN E3 [get_ports SystemClock]							
...
set_property PACKAGE_PIN K5 [get_ports RedR]					
	set_property IOSTANDARD LVCMOS33 [get_ports RedR]
##Bank = 15, Pin name = IO_L5P_T0_AD9P_15,					Sch name = LED16_G
set_property PACKAGE_PIN F13 [get_ports GreenR]				
	set_property IOSTANDARD LVCMOS33 [get_ports GreenR]
##Bank = 35, Pin name = IO_L19N_T3_VREF_35,					Sch name = LED16_B
set_property PACKAGE_PIN F6 [get_ports Idle]					
...
set_property PACKAGE_PIN E16 [get_ports Play]						
	set_property IOSTANDARD LVCMOS33 [get_ports Play]
##Bank = 15, Pin name = IO_L14P_T2_SRCC_15,					Sch name = BTNU
set_property PACKAGE_PIN F15 [get_ports Stop]						
	set_property IOSTANDARD LVCMOS33 [get_ports Stop]
##Bank = CONFIG, Pin name = IO_L15N_T2_DQS_DOUT_CSO_B_14,	Sch name = BTNL
set_property PACKAGE_PIN T16 [get_ports Record]						
...
set_property PACKAGE_PIN B13 [get_ports MISO]					
	set_property IOSTANDARD LVCMOS33 [get_ports MISO]
#Bank = 15, Pin name = IO_L5N_T0_AD9N_15,					Sch name = JA2
set_property PACKAGE_PIN F14 [get_ports nSS]					
	set_property IOSTANDARD LVCMOS33 [get_ports nSS]
#Bank = 15, Pin name = IO_L16N_T2_A27_15,					Sch name = JA3
set_property PACKAGE_PIN D17 [get_ports sCLK]					
